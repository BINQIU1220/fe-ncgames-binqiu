    ...
    if (error === 404) {
        return (
            <div className="error-404">
                <img
                    ...
                    alt="Error 404 image"
                ></img>
                <button className="back-home-btn-errorpage" onClick={() => { navigate("/") }}><AiFillHome /> Back Home</button>
            </div>
        );
        ...
        return (
            <div className="error-others">
                ...
                ></img> <button className="back-home-btn-errorpage" onClick={() => { navigate("/") }}><AiFillHome /> Back Home</button>
            </div>
        );
};
